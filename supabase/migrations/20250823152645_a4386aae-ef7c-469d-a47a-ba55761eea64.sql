...
-- Insert approved provider profiles with explicit IDs
INSERT INTO public.provider_profiles (
  ...
  ('aa111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'SparkleClean Co', 'Professional home and office cleaning with attention to detail.', 4.7, 152, 'approved', 6,
    ARRAY[
  ...
  ('bb222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'FixIT Tech Repair', 'Fast and reliable laptop, desktop, and phone repairs.', 4.8, 98, 'approved', 8,
    ARRAY[
  ...
  ('cc333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'GreenScape Pros', 'Lawn care and garden design that keeps your outdoors pristine.', 4.6, 73, 'approved', 5,
    ARRAY[
  ...
  ('dd444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'HandyHome Services', 'Experienced pros for plumbing, furniture assembly and more.', 4.9, 210, 'approved', 10,
    ARRAY[
